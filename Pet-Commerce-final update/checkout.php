            ...
            <div class="col-md-7">
                ...
                <form action="process_checkout.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3" placeholder="House number, street, area, etc." required></textarea>
                    </div>
    ...
    <script>
        document.querySelector('form').addEventListener('submit', function() {
            ...
            if (selectedPaymentMode) {
                document.getElementById('paymentMode').value = selectedPaymentMode.value;
            } else {
